  ...
  <v-col cols="12" sm="6">
    <apexchart
      ...
      :options="{
        ...
        xaxis: {title: {text: '年代'}, categories: items.number_of_deaths_reported_by_age_group.x_axis.data},
        yaxis: {title: {text: '死亡報告数 (人)'}},
        plotOptions: { bar: {horizontal: true, borderRadius: 2}}
      }"
      :series="[{name: items.number_of_deaths_reported_by_age_group.y_axis.name, data: items.number_of_deaths_reported_by_age_group.y_axis.data}]"
    ></apexchart>
  </v-col>
  </v-row>
  </v-container>
